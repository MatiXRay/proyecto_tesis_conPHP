...
<head>
    ...
    <title>Añadir Nueva Malta</title>
...
<main>
    ...
    <script>
        ...
        addMaltaForm.addEventListener('submit', function(event) {
            ...
            const tabla = 'variedades_malta'; // Nombre de la tabla
            ...
            .then(data => {
                if (data.success) {
                    ...
                    window.alert('Malta añadida con éxito.');
                    ...
                    window.alert('Error al añadir la malta.');
                }
            })
            .catch(error => {
