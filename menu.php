...
<aside id="sidebar" class="sidebar">
  ...
  <nav>
    ...
    <!-- Toggle de tema -->
    <div style="padding:1rem 1.25rem;border-top:1px solid var(--color-border);margin-top:auto">
      <button onclick="toggleTema()" id="btn-tema"
              style="width:100%;display:flex;align-items:center;gap:.6rem;padding:.5rem .75rem;
...
(function() {
  ...
  window.toggleTema = function() {
    ...
    localStorage.setItem('bialy-tema', nuevo);
    updateTemaBtn(nuevo);
  };
})();
</script>
